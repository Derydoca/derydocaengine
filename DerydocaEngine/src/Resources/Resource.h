...
namespace DerydocaEngine::Resources
{
	...
	public:
		...
		void setData(const std::shared_ptr<Object> data) { m_resourceObjectPointer = data; };
		...
		std::shared_ptr<Object> getResourceObjectPointer();
	...
	protected:
		...
		std::shared_ptr<Object> m_resourceObjectPointer;
	};
